...
namespace PetRancher1
{
    ...
    static class Tools
    {
        ...
        /// <returns></returns>
        public static string Print(ConsoleColor newFG = TextBasedGame.defaultFG,
                                    ConsoleColor newBG = TextBasedGame.defaultBG,
    ...
    /// </summary>
    public class PetStatusComponent
    {
    ...
    public class PetBattleComponent
    {
        public Pet master;
